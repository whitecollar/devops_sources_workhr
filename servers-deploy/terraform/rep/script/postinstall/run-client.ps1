...
# Получение копий эталонных баз
#Copy-Item "\\172.16.50.38\share\Distr\scripts\copy_etalon\*" -Destination "C:\Users\Public\Downloads" -Recurse
#New-Item -ItemType SymbolicLink -Path "C:\Users\Public\Desktop" -Name "Получить копию mdm.lnk" -Value "C:\Users\Public\Downloads\copy_mdm\dbcopier.bat"
#New-Item -ItemType SymbolicLink -Path "C:\Users\Public\Desktop" -Name "Получить копию mdm_erp.lnk" -Value "C:\Users\Public\Downloads\copy_erp\dbcopier.bat"
#New-Item -ItemType SymbolicLink -Path "C:\Users\Public\Desktop" -Name "Получить копию mdm_upp.lnk" -Value "C:\Users\Public\Downloads\copy_upp\dbcopier.bat"
